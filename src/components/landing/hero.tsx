            ...
            <div className="flex flex-col items-center justify-center gap-y-8 relative">
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    ...
                    <Container delay={0.2}>
                        ...
                        Turn sales, feedback, and trends into actionable insights to optimize operations, boost revenue, and enhance satisfaction.
                        </p>
                    </Container>
                    ...
                    <Container delay={0.3} className="relative">
                        <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
                            {/* Custom gradient */}
                            <div className="absolute top-1/8 left-1/2 -z-10 bg-gradient-to-r from-[#5321CA] to-[#1B005C] w-1/2 lg:w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[4rem] lg:blur-[10rem] animate-image-glow"></div>
                            <div className="hidden lg:block absolute -top-1/8 left-1/2 -z-20 bg-gradient-to-r from-[#5321CA] to-[#1B005C] w-1/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[10rem] animate-image-glow"></div>
